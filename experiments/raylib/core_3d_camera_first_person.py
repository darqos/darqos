...
def main():
    ...
    rl.init_window(screen_width, screen_height,
                   "raylib [core] example - 3d camera 1st person")
    ...
    while not rl.window_should_close():
        ...
        rl.draw_plane(rl.Vector3(0.0, 0.0, 0.0), rl.Vector2(32.0, 32.0),
                      rl.LIGHTGRAY)
        ...
        rl.draw_text("First person camera default controls:", 20, 20, 10,
                     rl.BLACK)
